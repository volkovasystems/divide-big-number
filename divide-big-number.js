...
( function module( base ){
	...
	*/
	moduleDefine( "divideBigNumber",
		function construct( ){
			var childprocess = require( "child_process" );
			var fs = require( "fs" );
			var path = require( "path" );
			var pathDirectory = process.cwd( ) + "/divide-big-number/".replace( "/", path.sep );
			var javaClassFile = pathDirectory + "divideBigNumber.class";
			var isJavaClassFileExist = fs.existsSync( javaClassFile );

			var divideBigNumber = function divideBigNumber( numbers, callback ){
				var parameters = Array.prototype.slice.apply( arguments );
				...
				var command = "java " + pathDirectory + "divideBigNumber " + numbers.join( " " );	
				if( !isJavaClassFileExist ){
					command = "javac " + pathDirectory + "divideBigNumber.java && " + command;
				}
			...
			base.divideBigNumber = divideBigNumber;
		} );
} )( base );